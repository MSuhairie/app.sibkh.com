...
<html>
<head>
 <title>Laporan Kegiatan Kerja RSUD Sungai Dareh - <?= $nama_bulan[ date('n', strtotime($_GET['tanggal_awal'])) - 1 ] ?> <?= date('Y', strtotime($_GET['tanggal_awal'])) ?></title>
</head>
<body>
  ...
  <div class="container">
    ...
    <div style="text-align: center;font-size: 15px;font-weight: 700;">LAPORAN KEGIATAN KERJA UPTD RSUD SUNGAI DAREH</div>
              ...
              <tbody>
                <?php 
                    ...
                    $query = mysqli_query($koneksi, "
                        ...
                        FROM tb_kegiatan k
                        INNER JOIN (
                            SELECT kegiatan, MIN(tgl) AS tgl
                            FROM tb_kegiatan
